...
def transform(cntr_0, cntr_n, dg_n, dg_n_trans):
    pts0 = []
    ...
    bundle = FiberBundle( "frame_0000000fiber_00.obj")
...
for i in range (0,180/5 + 1):
    ...
    cntr_0 = path + 'frame_0000000fiber_00_RED.obj'
    cntr_n =  path + 'frame_' + frameNum + 'fiber_00_RED.obj'
    ...
    transform(cntr_0, cntr_n, dg_n, dg_n_trans)