...
def write_head(f, record_filename):
    ...
    if (0):
        ...
        f.write('<bucketinfo size="1.28" numcells="16" record_filename="{}" output_step="500"/>\n'.format(record_filename)) 
...
def write_script(f):
    ###push on a sphere
    f.write('<script type="translate" x="0.0" y="0.0" z="4.0" w="0.0" start="0.0" end="2.0" group="1"/> \n')
    f.write('<script type="translate" x="0.0" y="0.0" z="4.0" w="0.0" start="0.0" end="2.0" group="2"/> \n')
    f.write('<script type="translate" x="0.0" y="0.0" z="4.0" w="0.0" start="0.0" end="2.0" group="3"/> \n')
    f.write('<script type="translate" x="0.0" y="0.0" z="4.0" w="0.0" start="0.0" end="2.0" group="4"/> \n')    
...
def write_sphere(f):
	print('<distancefield type="capsule" cx="0.0" cy="0.0" cz="1.3" rx="0.0" ry="0.0" rz="0.0" rw="1.5707963268" radius="1.2" halflength="0.0" group="5"/>' , file=f)
...
write_hair_collections(f, hair_counter)
write_end(f)
print(simulConfig + ' is written successfully!' )
